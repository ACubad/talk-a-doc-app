...
import { SidebarBody } from "./sidebar"; // Import SidebarBody
...
import { Dialog, DialogContent, DialogDescription, DialogFooter, DialogHeader, DialogTitle } from "@/components/ui/dialog"; // Import Dialog components for confirmation
...
export default function AppLayout({ children, user }: AppLayoutProps) {
  ...
  const deleteDocument = useCallback(async (documentId: string) => {
    // Use window.confirm for simplicity, replace with custom dialog if needed
